...
public class TicketRocketMQConstant {
     ...
     */
    public static final String TICKET_DELAY_CLOSE_CG_KEY = "tt_ticket-service_delay-close-order_cg${unique-name:}";

    /**
     * Canal 监听数据库余票变更 Topic Key
     */
    public static final String CANAL_COMMON_SYNC_TOPIC_KEY = "tt_canal_ticket-service_common-sync_topic${unique-name:}";

    /**
     * Canal 监听数据库余票变更业务消费者组 Key
     */
    public static final String CANAL_COMMON_SYNC_CG_KEY = "tt_canal_ticket-service_common-sync_cg${unique-name:}";
     ...
     * 支付结果回调购票消费者组 Key
     */
    public static final String PAY_RESULT_CALLBACK_TICKET_CG_KEY = "tt_pay-service_pay-result-callback-ticket_cg${unique-name:}";
}
