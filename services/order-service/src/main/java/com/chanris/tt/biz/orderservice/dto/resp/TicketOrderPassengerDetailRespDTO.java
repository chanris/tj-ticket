...
import com.chanris.tt.biz.orderservice.serialize.IdCardDesensitizationSerializer;
...
public class TicketOrderPassengerDetailRespDTO {
     ...
     * 车票状态
     */
    @AssembleEnum(type = OrderItemStatusEnum.class, ref = "statusName") // todo 24/9/5
